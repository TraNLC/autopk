📦
129104 /test/test-bag-il2cpp.js
✄
...
Il2Cpp.perform(function() {
  try {
      ...
      try {
        ...
        if (dict) {
          ...
          if (m_tables) {
            ...
            var m_entries = m_tables.field("m_entries").value;
            ...
            for (var i = 0; i < m_entries.length; i++) {
              ...
              if (val && !val.isNull()) {
                ...
                var itemData = { id: key };
                try {
                  itemData.name = itemObj.field("name").value.content;
                } catch (e) {
                }
                try {
                  itemData.count = itemObj.field("count").value;
                } catch (e) {
                }
                try {
                  itemData.level = itemObj.field("level").value;
                } catch (e) {
                }
                try {
                  itemData.series = itemObj.field("series").value;
                } catch (e) {
                }
                try {
                  itemData.price = itemObj.field("price").value;
                } catch (e) {
                }
                try {
                  itemData.sellPrice = itemObj.field("sellPrice").value;
                } catch (e) {
                }
                try {
                  itemData.gdp_g = itemObj.field("gdp_g").value;
                } catch (e) {
                }
                try {
                  itemData.gdp_d = itemObj.field("gdp_d").value;
                } catch (e) {
                }
                try {
                  itemData.gdp_p = itemObj.field("gdp_p").value;
                } catch (e) {
                }
                items.push(itemData);
              }
            }
            send({ type: "result", data: { ok: true, source: "GetAllGameItems", items } });
            return;
          }
        }
      } catch (e) {
    ...
    send({ type: "result", data: { ok: true, source: "MainCanvas", items } });
  } catch (e) {
