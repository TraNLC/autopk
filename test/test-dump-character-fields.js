...
async function run() {
    ...
    console.log("Dumping character class fields manually...");
    ...
    const fs = require('fs');
    fs.writeFileSync('test/temp-dump-character-fields.js', scriptCode);
    ...
    await frida.loadScript('test/temp-dump-character-fields.js');
}
