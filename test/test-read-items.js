...
var targetCid = process.argv[2] || "10819";
...
async function run() {
    ...
    console.log("Testing silent item reading for CID: " + targetCid);
    ...
    const scriptCode = `
        ...
        testReadItems('${targetCid}');
    `;
    
    const fs = require('fs');
    fs.writeFileSync('test/temp-read-items.js', scriptCode);
    ...
    await frida.loadScript('test/temp-read-items.js');
}
