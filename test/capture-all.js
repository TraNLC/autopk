...
async function run() {
    ...
    console.log('Listening for ALL packets (recv, send, writev, recvmsg, etc)...');
    ...
    const fs = require('fs');
    fs.writeFileSync('./test/temp-capture-all.js', scriptCode);
    await frida.loadScript('./test/temp-capture-all.js');
}
